...
bool barrier = false;
int sensorRange = 15;
const char *ssid = "StormFiber-ff78";
const char *password = "wlandb0087";
const char* apiKey = ""; //insert your webhook.site api key
const char* url = "https://webhook.site/9d78ce11-78cb-4a61-86f1-301907f1eff9"; //replace with your webhook.site api key
